...
# TS = A
rdm[j, 1, 2, 2] <- 1 #--------------------------------------------------|OS = U
rdm[j, 2, 2, 2] <- exp( rho[1, j] + bait_[1]) #--------------------------|OS = A
rdm[j, 3, 2, 2] <- 0 #--------------------------------------------------|OS = B
rdm[j, 4, 2, 2] <- 0 #--------------------------------------------------|OS = AB
# TS = B
rdm[j, 1, 3, 2] <- 1 #---------------------------------------- ---------|OS = U
rdm[j, 2, 3, 2] <- 0 #--------------------------------------------------|OS = A
rdm[j, 3, 3, 2] <- exp( rho[2, j] + bait_[2]) #--------------------------|OS = B
rdm[j, 4, 3, 2] <- 0 #--------------------------------------------------|OS = AB
# TS = AB
rdm[j, 1, 4, 2] <- 1 #--------------------------------------------------|OS = U
rdm[j, 2, 4, 2] <- exp( rho[1, j] + bait_[1]) #--------------------------|OS = A
rdm[j, 3, 4, 2] <- exp(                           rho[2, j] + bait_[2]) #|OS = B
rdm[j, 4, 4, 2] <- exp( rho[1, j] + bait_[1] +     rho[2, j] + bait_[2]) #|OS = AB
